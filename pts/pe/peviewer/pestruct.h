...
typedef struct _IMAGE_DOS_HEADER {
    ...
    unsigned int e_lfanew;      /* 3c: Offset to extended header */
...
typedef struct _IMAGE_OPTIONAL_HEADER {
    ...
    unsigned int SizeOfUnitializedData;
...
typedef struct _IMAGE_OPTIONAL_HEADER64 {
    ...
    unsigned short Subsystem;
    unsigned short DllCharacteristics;
    unsigned int long SizeOfStackReserve;
    unsigned int long SizeOfStackCommit;
    unsigned int long SizeOfHeapReserve;
    unsigned int long SizeOfHeapCommit;
